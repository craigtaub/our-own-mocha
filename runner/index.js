...
const Spec = require("./lib/reporters/spec");
const Base = require("./lib/reporters/base");
const runMocha = require("./lib/utils/run-helpers").runMocha;
const validatePlugin = require("./lib/utils/run-helpers").validatePlugin;
const handleRequires = require("./lib/utils/run-helpers").handleRequires;
...
parsingPhase() // lib cli/cli.js main()
